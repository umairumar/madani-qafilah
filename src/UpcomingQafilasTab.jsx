...
export default function UpcomingQafilasTab() {
      ...
      <div>
        ...
        >
          ...
          <div style={{ fontSize: 11, color: "#8899aa", lineHeight: 1.5 }}>
            Browse upcoming travel and Qafilah events from Gather Ummah and RSVP with one tap.
          </div>
        </div>
        <div
          style={{
        ...
        >
          <div style={{ fontSize: 12, fontWeight: 600, color: "#c8d0dc", marginBottom: 8 }}>Setup required</div>
          <div style={{ fontSize: 11, color: "#8899aa", lineHeight: 1.6, marginBottom: 12 }}>
            Add <code style={{ color: "#d4af7a" }}>VITE_SUPABASE_URL</code> and{" "}
            <code style={{ color: "#d4af7a" }}>VITE_SUPABASE_ANON_KEY</code> to your environment (see{" "}
            <code style={{ color: "#8899aa" }}>.env.example</code>).
          </div>
          <a
            href={TRAVEL_LISTING_URL}
            target="_blank"
            rel="noopener noreferrer"
            style={{ fontSize: 12, color: "#7aa0d4", fontWeight: 600 }}
          >
    ...
    <div>
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 8 }}>
          <div>
            <div style={{ fontSize: 12, fontWeight: 700, color: "#d4af7a", marginBottom: 4 }}>Upcoming Qafilas</div>
            <div style={{ fontSize: 11, color: "#8899aa", lineHeight: 1.5 }}>
              Upcoming travel events from Gather Ummah. Tap <strong style={{ color: "#c8d0dc" }}>I'm going</strong> to
              RSVP on Gather Ummah.
            </div>
          </div>
          <button
            type="button"
      ...
      {!loading && !error && events.length === 0 && (
        ...
        >
          ...
          <a
            ...
            style={{ fontSize: 12, color: "#7aa0d4", fontWeight: 600 }}
          >
            Browse all travel events on Gather Ummah →
          </a>
        </div>
      )}
            ...
            >
              <div style={{ display: "flex", gap: 0, flexDirection: event.image_url ? "row" : "column" }}>
                ...
                <div style={{ flex: 1, padding: "12px 14px" }}>
                  ...
                  <div style={{ fontSize: 11, color: "#6677aa", marginBottom: 10 }}>
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: 8, alignItems: "center" }}>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      style={{ fontSize: 11, color: "#7aa0d4", fontWeight: 600, textDecoration: "none" }}
                    >
                      View details
                    </a>
                  </div>
      ...
      >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          style={{ fontSize: 11, color: "#7aa0d4", fontWeight: 600 }}
        >
          View all travel events on Gather Ummah →
        </a>
      </div>
    </div>
  );
